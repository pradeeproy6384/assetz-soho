...
function validateForm() {
  ...
  if(currentFormOpen==="brochure-pdf")
    retURL = "http://www.assetzsohoskybooking.com/pdf/brochure.pdf";

  else if(currentFormOpen==="brochure-pricelist")
    retURL="http://www.assetzsohoskybooking.com/pdf/price.pdf";

  else if(currentFormOpen==="form-query")
    retURL="http://www.assetzsohoskybooking.com/thank-you.html";
  ...
  else if(currentFormOpen==="site-visit")
     retURL="http://www.assetzsohoskybooking.com/thank-you.html";
